...
How to run it:
    C:\python\Lib\site-packages\VTK\bin\vtkpython.exe task1_v03_stats.py 
...
def main():
    ...
    median.tofile('stats/v03_median.csv',sep='\n');
    mean.tofile('stats/v03_mean.csv', sep='\n');
    std.tofile('stats/v03_std.csv', sep='\n');
    size.tofile('stats/v03_size.csv', sep='\n');
    max_ar.tofile('stats/v03_max.csv', sep='\n');
    min_ar.tofile('stats/v03_min.csv', sep='\n');
    range_ar.tofile('stats/v03_range.csv',sep='\n');
