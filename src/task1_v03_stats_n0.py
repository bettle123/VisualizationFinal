...
How to run it:
    C:\python\Lib\site-packages\VTK\bin\vtkpython.exe task1_v03_stats_n0.py 
...
def main():
    ...
    files_ar.tofile('stats/filenames.csv', sep='\n');
    median.tofile('stats/v03_median_n0.csv',sep='\n');
    mean.tofile('stats/v03_mean_n0.csv', sep='\n');
    std.tofile('stats/v03_std_n0.csv', sep='\n');
    size.tofile('stats/v03_size_n0.csv', sep='\n');
    max_ar.tofile('stats/v03_max_n0.csv', sep='\n');
    min_ar.tofile('stats/v03_min_n0.csv', sep='\n');
    range_ar.tofile('stats/v03_range_n0.csv',sep='\n');
