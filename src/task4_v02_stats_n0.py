...
How to run it:
    C:\python\Lib\site-packages\VTK\bin\vtkpython.exe task4_v02_stats_n0.py 
...
def main():
    ...
    #for i in range(338, 339):
    for i in range(338, len(files)):
        ...
        median.tofile('stats/yA31/v02/v02_median_n0_46201.csv',sep='\n');
        mean.tofile('stats/yA31/v02/v02_mean_n0_46201.csv', sep='\n');
        std.tofile('stats/yA31/v02/v02_std_n0_46201.csv', sep='\n');
        size.tofile('stats/yA31/v02/v02_size_n0_46201.csv', sep='\n');
        max_ar.tofile('stats/yA31/v02/v02_max_n0_46201.csv', sep='\n');
        min_ar.tofile('stats/yA31/v02/v02_min_n0_46201.csv', sep='\n');
        range_ar.tofile('stats/yA31/v02/v02_range_n0_46201.csv',sep='\n');
